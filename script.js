...
function spawnTarget() {
  ...
  target.y = -10;
  target.speed = 3.5 + Math.floor(score / 50) * 0.5; // Kecepatan meningkat seiring skor
}
...
function render() {
  ...
  // Render Target (Bintang / Lingkaran Bersinar)
  ctx.shadowBlur = 10;
...
function saveScoreAndFetchLeaderboard() {
  leaderboardList.innerHTML = '<li class="loading">Menyimpan skor & memuat data...</li>';
